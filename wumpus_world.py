...
def get_user_config():
    ...
    ttk.Combobox(root, textvariable=pit_var, values=["0.2", "0.3", "0.4", "0.5"], font=font, height=height).pack()
...
def update_world_with_inference(world, KB, prev_pos, curr_pos, mode="standard"):
